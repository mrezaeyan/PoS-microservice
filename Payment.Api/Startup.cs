...
using Payment.Api.ObjectMapping;
...
namespace Payment.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<InvoiceCanceledEventHandler>();
            services.AddTransient<InvoiceConfirmedEventHandler>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            eventBus.Subscribe<InvoiceCanceledEvent, InvoiceCanceledEventHandler>();
            eventBus.Subscribe<InvoiceConfirmedEvent, InvoiceConfirmedEventHandler>();
        }
    }
}